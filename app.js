...
function startQuizMode() {
  ...
  console.log('Accord quiz généré:', lastSelectedChordName);
  
  // Masquer les notes de l'accord par défaut en mode quiz
  chordNotesVisible = false;
  console.log('chordNotesVisible mis à:', chordNotesVisible);
...
function updateDisplay(chordExists = null, forcedChordName = null) {
  ...
  // En mode quiz, afficher les notes jouées avec couleur (vert/rouge)
  if (quizMode && quizChord) {
