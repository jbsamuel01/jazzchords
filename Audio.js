// audio.js - Gestion de l'audio (synthèse et détection)
...
async function toggleMicrophone(onNoteDetected) {
  if (isListening) {
    if (mediaStream) {
    ...
    try {
      ...
      detectPitchFromMic(onNoteDetected);
      return true;
    } catch (err) {
...
function detectPitchFromMic(onNoteDetected) {
